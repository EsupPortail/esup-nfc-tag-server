...
privileged aspect Application_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Application.fieldNames4OrderClauseFilter = java.util.Arrays.asList("applisExtService", "nfcAuthConfigService", "tagIdCheckService", "name", "nfcConfig", "appliExt", "tagIdCheck", "description", "active");
