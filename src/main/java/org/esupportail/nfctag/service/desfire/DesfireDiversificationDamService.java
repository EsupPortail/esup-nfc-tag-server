...
public class DesfireDiversificationDamService {
    ...
    public byte[] getDamAuthKey(DamKeysTagWriteApi damKeysTagWriteApi, String csn) throws Exception {
        byte[] cardUid = DesfireUtils.hexStringToByteArray(csn);
        
        String diversDamKey;
        diversDamKey = damKeysTagWriteApi.getDiversDamKey(csn);
    ...
    public byte[] getDamEncKey(DamKeysTagWriteApi damKeysTagWriteApi, String csn) throws Exception {
        byte[] cardUid = DesfireUtils.hexStringToByteArray(csn);
        cardUid[0] = (byte) 0x00;
    ...
    public byte[] getDamMacKey(DamKeysTagWriteApi damKeysTagWriteApi, String csn) throws Exception {
        byte[] cardUid = DesfireUtils.hexStringToByteArray(csn);
        cardUid[0] = (byte) 0xFF;
    ...
    public String createDamBaseKey(DamKeysTagWriteApi damKeysTagWriteApi, String csn) {
        return damKeysTagWriteApi.createDiversDamKey(csn);
    }

    public String resetDamBaseKey(DamKeysTagWriteApi damKeysTagWriteApi, String csn) {
        return damKeysTagWriteApi.resetDiversDamKey(csn);
    }
