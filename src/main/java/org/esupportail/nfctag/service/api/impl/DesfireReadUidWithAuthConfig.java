...
import org.esupportail.nfctag.service.desfire.actions.DesfireReadUidWithAuthActionService;
import org.esupportail.nfctag.web.live.LiveLongPoolController;

public class DesfireReadUidWithAuthConfig extends DesfireReadConfig {
	...
	public DesfireActionService getDesfireActionService(DesfireService desfireService, TagAuthService tagAuthService, LiveLongPoolController liveController) {
		return new DesfireReadUidWithAuthActionService(this, desfireService, tagAuthService, liveController);
	}
