...
public class DesfireServiceTest {
    ...
    public void testWithConfigCsn() throws Exception {
        ...
        assumeTrue(desfireTags != null, "no desfireTags configured");
    ...
    public void testParseDesfireConfiguration(String csn) throws Exception {
        for(DesfireTag desfireTag : desfireTags) {
            if(desfireTag.getApplications() != null){
                for(DesfireApplication desApp : desfireTag.getApplications()) {
